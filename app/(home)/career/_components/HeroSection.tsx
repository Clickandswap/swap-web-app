...
function HeroSection() {
  return (
    <main className="md:py-20 py-10 md:px-52 px-6 text-dark bg-linear-to-r from-[#EFF6FF] to-[#FFFEF9]">
      ...
      >
        Help build the future <br /> cross-border money.
      </motion.h4>
      ...
      >
        We're a small team making cross-border payments faster and fairer for
        Africa and the diaspora. Come build with us.
      </motion.p>
      ...
      <motion.div
        ...
        className="w-full mt-8 h-110"
      >
        <Image
          src={"/company_page/about_us_img.png"}
          width={500}
          height={500}
          alt="ClickNSwap Career Image"
