...
function InternationalCard() {
  return (
    <main className="text-dark bg-[#FEE89D] lg:h-187.5 relative overflow-hidden flex flex-col lg:flex-row justify-between">
      <div className="lg:w-[40%] w-full px-6 lg:px-0 lg:ps-28 py-16">
        <motion.h2
        ...
        >
          <Button className="bg-dark lg:w-1/2 text-light flex items-center justify-center gap-1.5 font-space_grotesk">
            {" "}
            <IoLogoAppleAppstore /> <IoLogoGooglePlaystore /> Download App{" "}
          </Button>
          <Button className="border border-dark text-dark lg:w-1/2 font-space_grotesk">
            Use Prepaid
          </Button>
        </motion.div>
      </div>
      ...
      >
        <Image
          ...
          width={1200}
          height={500}
          className="lg:w-auto lg:h-auto w-full h-full lg:object-contain object-cover -right-60 top-0"
          loading="lazy"
        />
      </motion.div>
    </main>
