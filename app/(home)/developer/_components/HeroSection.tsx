...
function HeroSection() {
  return (
    <main className="text-dark">
      <div className="sm:px-28 px-6 py-16">
        <p className="bg-[#FEF0BD] py-2 px-5 w-fit mx-auto text-xs font-medium rounded-3xl">
          ClickNSwap For Developers
        </p>
        <h2 className="font-semibold leading-12 text-4xl sm:w-[45%] mx-auto font-space_grotesk text-center mt-4">
          Build something awesome with ClickNSwap
        </h2>

        <p className="text-base text-center mt-4 sm:w-[50%] mx-auto">
