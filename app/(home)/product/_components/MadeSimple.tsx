...
function MadeSimple() {
  return (
    <main className="sm:mx-18 md:pe-20 pe-0 pt-10 pb-6 md:pb-0 my-10 text-dark flex flex-col md:flex-row items-center justify-between bg-[#EEF9FF] rounded-lg overflow-hidden">
      <Image
        src={"/product_page/air_baloon.png"}
        alt="Baloon"
        width={400}
        height={200}
        className="w-auto h-auto object-cover relative -left-18"
      />
